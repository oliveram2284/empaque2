...
<section class="card">
  <div class="card-header">
    <span class="cui-utils-title">
      ...
      <a href="{{route('empresas.create')}}" class="btn btn-primary pull-right" >Nueva</a>
  </div>
  <div class="card-body">
    <div class="row">
      <div class="col-lg-12">        
                ...
                @foreach ($empresas as $item)
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="view_pass_bt btn btn-sm btn-icon btn-primary mr-2" href="{{ route('empresas.show',$item->id_empresa) }}" >
                                <i class="icmn-eye" aria-hidden="true"></i>                            
                            </a>

                            <a class="edit_bt btn btn-sm btn-icon btn-success mr-2" href="{{ route('empresas.edit',$item->id_empresa) }}"  >
                                <i class="icmn-pencil" aria-hidden="true"></i>                            
                            </a>                        
                         

                            <a class="delete_bt btn btn-sm btn-icon btn-danger mr-2 "  href="{{ route('empresas.destroy',$item->id_empresa) }}">
